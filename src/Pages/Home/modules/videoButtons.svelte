...
<div class:hidden={!isVideoLoaded} class="flex h-12 w-full items-center justify-center gap-3 rounded-md border border-[#a0a1a580] bg-gray-800 p-3">
  ...
  <!-- <Button text="Start" iconClass="fa-play" /> -->
</div>
